    ...
    public class MapperConfig : Profile
    {
        public MapperConfig() {
            ...
            CreateMap<ActivityAttendee, AttendeeDTO>()
                ...
                .ForMember(d => d.Following, o => o.MapFrom(s => s.AppUser.Followers.Any(x => x.Oberver.Email == currentUsername)));

            CreateMap<AppUser, Reactivities.Contracts.Users.Profile>()
                .ForMember(d => d.Image, o => o.MapFrom(s => s.Photos.FirstOrDefault(x => x.IsMain).Url))
                .ForMember(d => d.FollowersCount, o => o.MapFrom(s => s.Followers.Count))
                .ForMember(d => d.FollowingCount, o => o.MapFrom(s => s.Followings.Count))
                .ForMember(d => d.Following, o => o.MapFrom(s => s.Followers.Any(x => x.Oberver.Email == currentUsername)));
